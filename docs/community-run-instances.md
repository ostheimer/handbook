...
| URL    | Non-Google STUN/TURN  | On Amazon, Google, Cloudflare or Microsoft   | SSL Test  | hoster |
|---|---|---|---|---|
| meet.ustavimokorono.si |  ✅  |   |  [run SSL check!](https://www.ssllabs.com/ssltest/analyze.html?d=meet.ustavimokorono.si&latest) |    |
...
| jitsi.komun.org | ✅   |   | [run SSL check!](https://www.ssllabs.com/ssltest/analyze.html?d=jitsi.komun.org&latest) |  |
...
| meet.dssr.ch |  |  |  [run SSL check!](https://www.ssllabs.com/ssltest/analyze.html?d=meet.dssr.ch&latest) | Init7  |
